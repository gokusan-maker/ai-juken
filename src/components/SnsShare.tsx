...
export function SnsShare({ title, url, description = "" }: SnsShareProps) {
  ...
  return (
    <div className="flex flex-col gap-3">
      <p className="text-sm font-medium text-gray-600">この記事をシェア</p>
      <div className="flex flex-wrap gap-2">
        {shareLinks.map((link) => (
          <a
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 text-gray-600 transition-colors ${link.color}`}
